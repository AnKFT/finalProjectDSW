...
def build_it():
	...
	for doc in collection.find():
		if request.form['id'] == str(doc.get('_id')):
			...
			listing+='<label for="category">Category</label><select class="form-control" id="form-control" name="thecategory"><option value="animals">Animals</option><option value="books">Books</option><option value="board-games">Board Games</option><option value="brogle">Brogle</option><option value="cars">Cars</option><option value="computers">Computers</option><option value="dieting">Dieting</option><option value="dvds">DVDs & Movies</option><option value="electronics">Electronics</option><option value="education">Education</option><option value="food">Food</option><option value="fantastics">Fantastic Sams</option><option value="gallery">Gallery</option><option value="garbage">Garbage</option><option value="houses">Household Items</option><option value="happy">Happy Products</option><option value="instruments">Instruments</option><option value="iguana">Iguanas</option><option value="jewelry">Jewelry</option><option value="large">Large Products</option><option value="lamps">Lamps</option><option value="music">Music</option><option value="magic">Magical Products</option><option value="pottery">Pottery</option><option value="pets">Pets</option><option value="red">Red Products</option><option value="rollercoasters">Rollercoasters</option><option value="sports">Sporting Goods</option><option value="spooky">Spooky Products</option><option value="toys">Toys</option><option value="travel">Traveling</option><option value="video-games">Video Games</option><option value="vehicles">Vehicles</option><option value="winter">Winter Products</option><option value="xray">X-Ray Machines</option><option value="yoga">Yoga Products</option><option value="yogurt">Yogurt</option><option value="sleep">ZzZ</option><option value="etc">Other Products</option></select>'
